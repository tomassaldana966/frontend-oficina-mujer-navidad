...
import { generarPDF } from "./generatePDF-legacy";
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
              ...
              <div className="relative">
                ...
                >
                  <option value="" disabled hidden>
                    Indique la identidad de genero del alumno(opcional)
                  </option>
            ...
            <div className="w-full px-3 mb-6">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="Ballet Folclórico Municipal">
                  ...
                  <option value="Escuela de Talentos">
                    Escuela de Talentos
                  </option>
                  ...
                  <option value="Teatro Adulto Mayor">
                    Teatro Adulto Mayor
                  </option>
                  ...
                  <option value="Plan Formativo Cine">
                    Plan Formativo Cine
                  </option>
                  <option value="Plan Formativo Danza">
                    Plan Formativo Danza
                  </option>
                  <option value="Plan Formativo Teatro">
                    Plan Formativo Teatro
                  </option>
                  <option value="Plan Formativo Artes Visuales">
                    Plan Formativo Artes Visuales
                  </option>
                  <option value="Plan Formativo Fotografía">
                    Plan Formativo Fotografía
                  </option>
                  <option value="Plan Formativo Música">
                    Plan Formativo Música
                  </option>
                </select>
                <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                  <svg
            ...
            <div className="w-full px-3 mb-6">
              ...
              >
                ...
                {Array.from({ length: 2031 - 2018 }, (_, i) => 2018 + i).map(
                  (year) => (
